...
// uppercase conversion-needed some help with this
...
function generatePassword() {
    howLong = parseInt(prompt("How many characters would you like your password? Choose between 8 and 128"));
    ...
    if (!confirmCharacter && !confirmNumber && !confirmUppercase && !confirmLowercase) {
        choices = alert("Your choice was invalid, please start again!");
